...
template <typename Data> class ListGeneric {
 public:
...
template <typename Data>
ListGeneric<Data>::ListGeneric() {_head = NULL;}
template <typename Data>
...
template <typename Data> ListGenericIterator<Data>::ListGenericIterator(ListGeneric<Data> * list) {
  _list = list;
  _currentEntry = _list->_head;
}

template <typename Data> bool ListGenericIterator<Data>::next(Data & data) {
